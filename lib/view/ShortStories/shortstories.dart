...
class shortstories extends StatefulWidget {
  const shortstories({super.key});

  @override
  State<shortstories> createState() => _shortstoriesState();
}

class _shortstoriesState extends State<shortstories> {
  @override
  void initState() {
